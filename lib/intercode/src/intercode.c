...
Quad ic_translate_stmt(Arena arena, HashTable hashtable, ASTN_Stmt node, uint32_t*  temp_counter, uint32_t* label_counter) {
  ...
  switch (node -> type){
    ...
    case STMT_VAR_INCR_BEFORE:{
      ...
      store->add2.type = AT_String;
      store->add2.value.label = strdup(node ->stmt._assign.var->value.ident);
      store->add3 = NULL;
      store->add4 = NULL;
      store->next = NULL;
    ...
    case STMT_VAR_EQUALS_PLUS:{
      ...
      add->add1.type = AT_Temp;
      add->add1.value.temp = temp;
      add->add2.type = expr -> add1.type;
      add->add2.value = expr -> add1.value; 
      add->add3.type = AT_Temp;
      add->add3.value.temp = result; 
      add->add4 = NULL;
      add->next = NULL;
    ...
    case STMT_VAR_EQUALS_MINUS:{
      ...
      sub->add1.type = AT_Temp;
      sub->add1.value.temp = temp;
      sub->add2.type = expr -> add1.type;
      sub->add2.value = expr -> add1.value; 
      sub->add3.type = AT_Temp;
      sub->add3.value.temp = result; 
      sub->add4 = NULL;
      sub->next = NULL;
    ...
    case STMT_VAR_EQUALS_MUL:{
      ...
      mult->add1.type = AT_Temp;
      mult->add1.value.temp = temp;
      mult->add2.type = expr -> add1.type;
      mult->add2.value = expr -> add1.value; 
      mult->add3.type = AT_Temp;
      mult->add3.value.temp = result; 
      mult->add4 = NULL;
      mult->next = NULL;
    ...
    case STMT_VAR_EQUALS_DIV: {
      ...
      div_quad ->add1.type = AT_Temp;
      div_quad ->add1.value.temp = temp;
      div_quad ->add2.type = expr -> add1.type;
      div_quad ->add2.value = expr -> add1.value; 
      div_quad ->add3.type = AT_Temp;
      div_quad ->add3.value.temp = result; 
      div_quad ->add4 = NULL;
      div_quad ->next = NULL;
